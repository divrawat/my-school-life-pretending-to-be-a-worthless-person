...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const DESCRIPTION = `Read ${MANGA_NAME} chapter ${chapterNumber} online. The story follows a protagonist who chooses a peculiar path: pretending to be worthless. There could be several reasons behind this facade. Perhaps the protagonist possesses hidden abilities they want to conceal.`
